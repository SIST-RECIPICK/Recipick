...
public interface ReviewMapper {
	...
	public List<Review_BoardVO> ReviewBoardListData(@Param("start") int start, @Param("keyword") String keyword, @Param("type") String type);
	public int reviewBoardTotalpage(@Param("keyword") String keyword, @Param("type") String type);
